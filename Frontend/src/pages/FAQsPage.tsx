            ...
            <div className="QA">
                <Accordion defaultActiveKey="0">
                    <Accordion.Item eventKey="0">
                        ...
                        <Accordion.Body>
                            <strong>You don't need an account to use the basic functions of the app.</strong> <br/>
                    ...
                    <Accordion.Item eventKey="2">
                        ...
                        <Accordion.Body>
                            <strong>Yes</strong>,  <br/> the app allows you to save your favorite recipes in a
                    ...
                    <Accordion.Item eventKey="3">
                        ...
                        <Accordion.Body>
                            <strong>Yes</strong>,  <br/> you can generate a shopping list directly from a recipe, which
